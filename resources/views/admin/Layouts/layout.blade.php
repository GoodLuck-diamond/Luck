...
<head>
    ...
    <!-- Font Awesome , overlayScrollbars -->
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                <!--  <img src="{{ asset('No_image_available.svg.png') }}" class="img-circle elevation-2" alt="User Image">-->
                </div>
                <div class="info">
...
<!-- jQuery , Bootstrap 4 , AdminLTE App , AdminLTE for demo purposes -->
